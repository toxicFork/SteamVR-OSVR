...
#ifndef INCLUDED_osvr_camera_device_h
#define INCLUDED_osvr_camera_device_h

// Internal Includes
#include "./osvr_tracked_device.h"

class OSVRCameraDevice : public OSVRTrackedDevice
{
public:
    OSVRCameraDevice(osvr::clientkit::ClientContext& context, vr::IServerDriverHost* driver_host, vr::IDriverLog* driver_log = nullptr);
...
#endif // INCLUDED_osvr_camera_device_h
